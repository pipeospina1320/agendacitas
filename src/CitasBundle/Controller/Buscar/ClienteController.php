...
namespace CitasBundle\Controller\Buscar;
...
class ClienteController extends Controller {
    ...
    public function listaAction(Request $request, $campoNit, $campoNombre) {
        ...
        return $this->render('CitasBundle:Buscar:cliente.html.twig', array(
    ...
    private function lista() {
        $em = $this->getDoctrine()->getManager();
        $this->strDqlLista = $em->getRepository('CitasBundle:Cliente')->listaDQL(
