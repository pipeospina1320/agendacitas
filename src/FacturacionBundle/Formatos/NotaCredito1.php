...
class NotaCredito1 extends \FPDF_FPDF {
    ...
    public function Footer() {
        ...
        $this->SetXY(149,217);
        $this->Cell(28, 7, 'VALOR BRUTO', 1, 0, 'L');        
        ...
        $this->Text(20, 240, "Actividad Comercial");
        $this->Text(60, 240, $arFactura->getClienteRel()->getSectorComercialRel()->getNombre());
        $this->Text(90, 240, "Estrato =");
        $this->Ln(4);
        //$this->SetFont('Arial', '', 8);
