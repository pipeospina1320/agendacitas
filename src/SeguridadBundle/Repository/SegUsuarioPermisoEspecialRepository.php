    ...
    public function permisoEspecial($arUsuario, $codigoPermisoEspecial) {        
        ...
        if($boolAdministrador == 1) {
          $boolPermiso = 1;  
            ...
            $arUsuarioPermisoEspecial = $em->getRepository('SeguridadBundle:SegUsuarioPermisoEspecial')->findOneBy(array('codigoUsuarioFk' => $arUsuario->getId(), 'codigoPermisoEspecialFk' => $codigoPermisoEspecial));
