...
use ContabilidadBundle\Entity\Comprobante;
...
class ComprobanteController extends Controller
{
    ...
    public function listaAction()
    {
        ...
        $comprobantes = $em->getRepository('ContabilidadBundle:Comprobante')->findAll();

        return $this->render('ContabilidadBundle:Comprobante:lista.html.twig', array(
    ...
    public function nuevoAction(Request $request)
    {
        ...
        $form = $this->createForm('ContabilidadBundle\Form\ComprobanteType', $comprobante);
        ...
        return $this->render('ContabilidadBundle:Comprobante:nuevo.html.twig', array(
    ...
    public function showAction(Comprobante $comprobante)
    {
        ...
        return $this->render('ContabilidadBundle:Comprobante:show.html.twig', array(
            'comprobante' => $comprobante,
    ...
    {
        $deleteForm = $this->createDeleteForm($comprobante);
        $editForm = $this->createForm('ContabilidadBundle\Form\ComprobanteType', $comprobante);
        ...
        return $this->render('ContabilidadBundle:Comprobante:editar.html.twig', array(
            'comprobante' => $comprobante,
